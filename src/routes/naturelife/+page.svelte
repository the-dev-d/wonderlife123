...
<div class="bg-emerald-50">
  <main class="w-full h-[50vh] md:h-[90vh]">
    <Banner>
      ...
      <div slot="foreground" class="grid content-center h-full px-6 md:w-1/2">
        <h3 class="text-3xl font-semibold text-white md:text-5xl">Nature Life</h3>
        <h5 class="my-3 text-gray-200 md:text-lg">
          Harmonize with Nature's Healing Essence: Embrace Vitality through Nature Life.
        </h5>
        <div class="grid gap-6 my-6 w-fit md:flex md:w-full">
          <button
            class="p-3 font-semibold text-white transition-all border-2 md:text-lg hover:text-nature-primary hover:bg-lime-50 border-nature-primary bg-nature-primary"
            >Get Started</button
          >
          <button
            class="p-3 font-semibold text-white transition-all border-2 md:text-lg hover:text-nature-primary backdrop-blur-sm border-nature-primary"
            >Know More</button
          >
        </div>
      </div>
      <Navbar class="text-nature-primary" slot="header" logo="ayur/ayur-life.webp" title="NATURE LIFE">
        <ul
          slot="options"
  ...
  <section class="container grid py-6 mx-auto my-10 place-items-center">
    <div class="w-full py-6 mx-auto lg:w-2/3">
      <h3 class="w-full mb-6 text-3xl font-semibold text-center">Nature Life</h3>
      <p class="m-6 text-center font-bree">
        Nature Life embodies the transformative essence of nature in promoting holistic well-being. It utilizes natural remedies and therapies to harness the healing power of plants and minerals. By fostering a deep connection with the natural world, Nature Life nurtures vitality, harmony, and a profound sense of rejuvenation.
      </p>
    </div>
  </section>
  ...
  <section class="container mx-auto my-10 mb-20">
    <h4
      class="mx-auto my-8 text-3xl font-semibold text-center border-b-2 w-fit border-nature-primary text-nature-primary"
    >
        ...
        <div class="container w-full mx-auto my-16 md:px-10">
          ...
          <div class="w-full mt-20 lg:w-1/2">
            ...
            <p class="mt-10 text-center lg:text-left">
              Nature Life offers a profound approach to well-being, 
              rooted in the transformative power of nature. By reconnecting with the natural world, 
              we tap into its inherent healing energy. 
              Nature Life recognizes the vital connection between humans and the environment, 
              promoting a sense of grounding, tranquility, and harmony. Through the use of natural remedies and therapies, 
              Nature Life harnesses the healing properties of plants, minerals, and other elements found in nature. 
              These gentle yet potent interventions work in harmony with the body's own healing mechanisms, 
              supporting holistic wellness.
            </p>
            <p class="mt-5">
              Nature Life encourages individuals to embrace the outdoors, 
              fostering a deeper connection with the natural world and nurturing a sense of awe and gratitude. 
              By embracing Nature Life, we embark on a journey of healing and rejuvenation, 
              where the beauty and wisdom of nature guide us towards vibrant health and vitality.
            </p>
          </div>
        </div>
      </div>
  ...
  <!-- <section class="p-3 mx-auto my-14 lg:container">
    <div
      class="w-full px-6 py-6 border-2 rounded-md shadow-md bg-opacity-70 bg-nature-primary"
    >
  ...
  <section class="container p-6 mx-auto my-10">
    <div class="w-full">
      <h3
        class="my-10 text-3xl font-bold border-b-2 border-nature-primary text-nature-primary"
      >
        Reach us
      </h3>
      <ContactForm primaryClass="nature-primary">
        <span class="grid" slot="head">
          <h4 class="font-semibold text-nature-primary">Connect with Us</h4>
          <p class="text-sm text-ayur-text">Your Wellness Journey Begins Here. Reach out to Wonder Life Today!</p>
        </span>
        <div slot="body">
          <Icon color="nature-primary"
            label="Saras Tower Thuppumpadi, Thalacode P.O, Mulanthuruthy Ernakulam, PIN-682314"
          >
            <i class="fa-solid fa-location-dot" />
          </Icon>
          <Icon color="nature-primary" label="+91 9632038278, +91 9633136484">
            <i class="fa-solid fa-mobile-screen-button" />
          </Icon>
          <Icon color="nature-primary" label="contact@wonderlife123.in">
